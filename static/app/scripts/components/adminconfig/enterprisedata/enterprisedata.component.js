  ...
  angular.module('unbOportunidade')
    ...
    .controller("EnterpriseController", ["$scope", function($scope) {
      ...
      $scope.data.areas = { // Should get this from API
         availabeAreas: [
           {id: '1', name: 'Selecione uma Área'},
           {id: '2', name: 'Admnistração'},
           {id: '3', name: 'Biblioteconomia'},
           {id: '4', name: 'Ciência da Computação'}
         ],
         selectedArea: {id: '1', name: 'Selecione uma Área'} //This sets the default value of the select in the ui
         };
